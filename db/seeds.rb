...
[
  ['長袖トップス', '0', '良品です！', '66', 'M', 'ナイキ', '新品、未使用', '送料込み（出品者負担）', '北海道','2-3日', '1800', '1', '1',],
  ['レディースジャケット', '0', '良品です！', '64', 'M', '', '未使用に近い', '着払い（購入者負担）', '横浜','5日', '3200', '2', '1',],
  ['おすすめレディースジャケット', '0', '良品です！', '68', 'M', 'シャネル', '目立った傷や汚れなし', '送料込み（出品者負担）', '北海道','2-3日', '5600', '1', '1',],
  ['GUコーデ', '0', '良品です！', '221', 'M', '', 'やや傷や汚れあり', '着払い（購入者負担）', '青森','2-3日', '2600', '1', '1',],
  ['冬アウター', '0', '良品です！', '63', 'M', 'ナイキ', '傷や汚れあり', '送料込み（出品者負担）', '岩手','3年', '1300', '1', '1',],
  ['お気に入りジャケット', '0', '良品です！', '67', 'M', 'シャネル', '全体的に状態が悪い', '着払い（購入者負担）', '秋田','1.5年', '4200', '1', '1',],
  ['あったかジャケット', '0', '良品です！', '65', 'M', 'ナイキ', '新品、未使用', '送料込み（出品者負担）', '栃木','1日', '1400', '1', '1',],
  ['ジャケット', '0', '良品です！', '64', 'M', 'シャネル', '未使用に近い', '着払い（購入者負担）', '東京','5日', '2100', '1', '1',],
  ['セーター', '0', '良品です！', '68', 'M', 'ナイキ', '目立った傷や汚れなし', '送料込み（出品者負担）', '東京','5日', '6800', '1', '1',],
  ['アウター', '0', '良品です！', '69', 'M', 'シャネル', 'やや傷や汚れあり', '着払い（購入者負担）', '東京','5日', '2100', '1', '1',],
  ['ZARA アウター', '0', '良品です！', '221', 'M', '', '傷や汚れあり', '送料込み（出品者負担）', '東京','5日', '7000', '1', '1',],
  ['冬アウター', '0', '良品です！', '64', 'M', '', '全体的に状態が悪い', '着払い（購入者負担）', '岩手','3年', '1300', '1', '1',],
  ['お気に入りジャケット', '0', '良品です！', '221', 'M', '', '新品、未使用', '送料込み（出品者負担）', '秋田','1.5年', '4200', '1', '1',],
  ['ユニクロ あったかジャケット', '0', '良品です！', '64', 'M', '', '未使用に近い', '着払い（購入者負担）', '栃木','1日', '1400', '1', '1',],
  ['テーラードジャケット', '0', '良品です！', '221', 'M', '', '目立った傷や汚れなし', '送料込み（出品者負担）', '東京','5日', '2100', '1', '1',],
  ['カシミア ジャケット', '0', '良品です！', '64', 'M', '', 'やや傷や汚れあり', '着払い（購入者負担）', '東京','5日', '6800', '1', '1',],
  ['Forever21 アウター', '0', '良品です！', '221', 'M', '', '傷や汚れあり', '送料込み（出品者負担）', '東京','5日', '2100', '1', '1',],
